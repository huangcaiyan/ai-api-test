...
class Email:
    ...
    def config_content ( self ):
        ...
        :return:
        """
        f = open (os.path.join (read_config.pro_dir , 'testFile' , 'emailStyle.txt'))
        content = f.read ()
        f.close ()
    ...
    def config_image ( self ):
        ...
        """
        # defined image path
        image1_path = os.path.join (read_config.pro_dir , 'testFile' , 'img' , '1.png')
        ...
        self.msg.attach (msg_image1)

        image2_path = os.path.join (read_config.pro_dir , 'testFile' , 'img' , 'logo.jpg')
    ...
    def config_file ( self ):
        ...
        if self.check_file ():
            ...
            zip_path = os.path.join (read_config.pro_dir , "result" , "test.zip")
